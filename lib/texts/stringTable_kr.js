...
const stringTable_kr = {
  ...
  "public": {
    "common": {
      ...
      reference: "제공: ",
      linkText: "에서 보기",
      linkTextList: ["/link", "에서 ", "/city", " 더 알아보기"],
      emoji: {
        great: "😍",
        good: "😃",
        soso: "🤔",
    ...
    tripTag: {
      [_TripTag.TripTag.PHOTO]: "사진사",
      [_TripTag.TripTag.EAT]: "미식가",
      [_TripTag.TripTag.FRIENDSHIP]: "우정의 수호자",
      [_TripTag.TripTag.PHYSICAL]: "액티비티",
      [_TripTag.TripTag.REST]: "휴식이 필요해",
      [_TripTag.TripTag.INFLUENCER]: "인플루언서",
      [_TripTag.TripTag.COFFEE]: "카페 탐방",
      [_TripTag.TripTag.CULTURE]: "문화 생활",
      [_TripTag.TripTag.ADVENTURE]: "모험가",
      [_TripTag.TripTag.PASSION]: "열정적",
      [_TripTag.TripTag.REFRESH]: "재충전"
    },
    "test": {
      activity: {
        title: "액티비티",
        tagSet: {
          [_ActivityTag.ActivityTag.PHOTO]: "사진",
          [_ActivityTag.ActivityTag.INSTA]: "인스타그램",
          [_ActivityTag.ActivityTag.NETWORK]: "여행지에서 친구 사귀기",
          [_ActivityTag.ActivityTag.EXTREME]: "익스트림 액티비티",
          [_ActivityTag.ActivityTag.SWIM]: "물놀이",
          [_ActivityTag.ActivityTag.DRIVE]: "드라이브",
          [_ActivityTag.ActivityTag.WALK]: "산책",
          [_ActivityTag.ActivityTag.THEMEPARK]: "테마파크",
          [_ActivityTag.ActivityTag.MARKET]: "시장 구경",
          [_ActivityTag.ActivityTag.HOTEL]: "호캉스",
          [_ActivityTag.ActivityTag.VLOG]: "브이로그",
          [_ActivityTag.ActivityTag.WAITING]: "맛집 웨이팅",
          [_ActivityTag.ActivityTag.BAR]: "근사한 바에서 술",
          [_ActivityTag.ActivityTag.CAFE]: "카페 탐방",
          [_ActivityTag.ActivityTag.SHOPPING]: "쇼핑",
          [_ActivityTag.ActivityTag.SHOW]: "공연"
        }
      },
      expectation: {
        title: "제네럴",
        tagSet: {
          [_ExpectationTag.ExpectationTag.HEAL]: "치유되는",
          [_ExpectationTag.ExpectationTag.COMPACT]: "알찬",
          [_ExpectationTag.ExpectationTag.FULLFILL]: "보람있는",
          [_ExpectationTag.ExpectationTag.MEMORY]: "추억",
          [_ExpectationTag.ExpectationTag.RELAX]: "여유로운",
          [_ExpectationTag.ExpectationTag.COMFORT]: "편안한",
          [_ExpectationTag.ExpectationTag.ADVENTURE]: "모험",
          [_ExpectationTag.ExpectationTag.NEW]: "새로운 경험",
          [_ExpectationTag.ExpectationTag.DIGITAL_DETOX]: "디지털 디톡스",
          [_ExpectationTag.ExpectationTag.REST]: "휴식",
          [_ExpectationTag.ExpectationTag.VIEW]: "풍경",
          [_ExpectationTag.ExpectationTag.FRIENDSHIP]: "우정"
        }
      }
    },
    "contents": {
      ...
      "test": {
        ...
        "test": {
          ...
          "tagSet": {
            ...
            selectWarningStringList: ["", "개 이상 선택해주세요."]
          },
          "activity": {
            title: "이런 활동은 어때?",
            subtitle: "즐기기",
        ...
        "subTest": {
          ...
          "food": {
            ...
            subtitle: "예산 - 식사",
            "examples": {
              5000: ["kyudong", "wantang", "churos"],
              15000: ["ramen", "udon", "dumpling"],
              25000: ["sushi", "afternoon-tea"],
              50000: ["hitsumabushi", "yakitori", "chili-crab"],
              75000: ["mandarin-grill"]
            },
            "carouselTitleDefault": "선택한 가격대에서 즐길 수 있는\n전세계의 곳곳의 식당들을\n여기에 보여줄게",
            "carouselTitle": "대에서 즐길 수 있는 전세계의 식당들",
            "budgetLowerBounds": [5000, 15000, 25000, 50000],
            "sliderProps": {
              "step": 5000,
              "min": 5000,
              "max": 70000
      ...
      "chemistry": {
        ...
        "sections": {
          ...
          "leadership": {
            ...
            "idPostfix": "님",
            "and": ",",
            "body": ["리더", "/idList", "이 여행 계획과 준비를 주도적으로 이끌어 주면 좋을 것 같아요."],
            "detail": ["/idList", "은 계획을 리드할 부담은 갖지 않아도 좋아요. 대신 여행에서 어떤 걸 하고 싶은지, 어떤 건 마음에 들지 않는지 적극적으로 이야기해주세요. 리더를 도와 멋진 여행 계획을 함께 준비해봐요."]
          },
          "schedule": {
            label: "일정",
            icon: "edit_calendar",
...
var _default = exports.default = stringTable_kr;