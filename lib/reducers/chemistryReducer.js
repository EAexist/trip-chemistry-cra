...
exports.useProfile = exports.useIsChemistryEnabled = exports.useCityChemistry = exports.useChemistryLoadStatus = exports.useChemistryId = exports.useChemistry = exports.default = exports.clearChemistry = exports.asyncJoinChemistry = exports.asyncGetChemistry = exports.asyncCreateChemistry = void 0;
...
const useSortedCityList = () => {
  return (0, _reactRedux.useSelector)(state => state.chemistry.data.cityChemistry ? Object.entries(state.chemistry.data.cityChemistry).sort((a, b) => b[1] - a[1]).map(([cityClass, score]) => cityClass) : undefined);
};
...
function useProfileAll(idList, key, answeredProfileOnly = true) {
  return (0, _reactRedux.useSelector)(state => Object.values(state.chemistry.data.profileList).filter(({
    id
