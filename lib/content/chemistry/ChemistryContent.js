...
var _LoadRequiredContent = _interopRequireDefault(require("../LoadRequiredContent"));
...
function ChemistryContent({}) {
  ...
  const [chemistryLoadStatus, setChemistryLoadStatus] = (0, _chemistryReducer.useChemistryLoadStatus)();
  ...
  const [isInviteOptionsOpen, setIsInviteOptionsOpen] = (0, _react.useState)(false);
  ...
  const handleChemistryFail = () => {
    setChemistryLoadStatus(_LoadStatus.LoadStatus.REST);
  };
  ...
  const handleJoinChemistry = isAuthorized ? () => {
    ...
    navigate('../login', {
      state: {
        loginRedirectPath: `chemistry/${chemistryId}`
      }
    });
  };
  ...
  (0, _react.useEffect)(() => {
    ...
    if (chemistryId) {
      dispatch((0, _chemistryReducer.asyncGetChemistry)(chemistryId));
    }
  }, [chemistryId, dispatch]);
  (0, _react.useEffect)(() => {
    if (chemistryLoadStatus === _LoadStatus.LoadStatus.SUCCESS) {
      // dispatch( setAllREST() );
      /* @TODO Animate */
      setChemistryLoadStatus(_LoadStatus.LoadStatus.REST);
    }
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_LoadRequiredContent.default, {
    ...
    children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_HelmetWrapper.default, {
      ...
      children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_SectionPaper.default, {
        className: "block__body--large body__head",
        children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
          ...
          children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_material.List, {
            children: Object.values(profileList).map(({
              ...
              secondaryAction: testAnswer === null && /*#__PURE__*/(0, _jsxRuntime.jsxs)(_material.Stack, {
                children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_iconsMaterial.Error, {}), /*#__PURE__*/(0, _jsxRuntime.jsx)("p", {
          ...
          children: isMember ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_LazyDomAnimation.default, {
            children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_framerMotion.m.div, {
              children: isInviteOptionsOpen ? /*#__PURE__*/(0, _react.createElement)(_framerMotion.m.div, {
                ..._props.FADEIN_VIEWPORT,
                key: String(isInviteOptionsOpen)
                ...
                children: [{
                  ...
                  children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_material.Button, {
                    onClick: onClick,
                    startIcon: /*#__PURE__*/(0, _jsxRuntime.jsx)(_material.Icon, {
                      children: icon
                    }),
                    variant: "outlined",
      ...
      (0, _jsxRuntime.jsx)(_material.Paper, {
        ...
        children: /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
          ...
          children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_SectionPaper.default, {
            ...
            className: "block__body--large block--with-margin--small flex",
